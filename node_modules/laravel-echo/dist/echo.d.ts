...
declare class SocketIoChannel extends Channel {
     ...
     * Create a new class instance.
     */
    constructor(socket: SocketIoSocket, name: string, options: EchoOptionsWithDefaults<BroadcastDriver>);
    /**
...
declare type SocketIoFunction = (uri?: string, opts?: Record<string, unknown>) => SocketIoSocket;

/**
 * Minimal Socket.io type shim.
 */
declare interface SocketIoManager {
    /* Excluded from this release type: _reconnecting */
...
declare interface SocketIoSocket {
    id: string | undefined;
    connected: boolean;
    io: SocketIoManager;
    on(event: string, callback: (...args: any[]) => void): this;
