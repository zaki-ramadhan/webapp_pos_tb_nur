...
4. **Penjualan (Sales)**: Input faktur penjualan, pelunasan piutang pelanggan, retur penjualan, dan sales check-in.
5. **Persediaan (Inventory)**: Permintaan barang antar gudang, penyesuaian stok, stock opname, dan cek stok per gudang.
