...
| Master Produk | barang, kategori, satuan, harga, stok per gudang | `Barang`, `Kategori Barang`, `Satuan Barang`, `Harga Pemasok`, `Barang per Gudang` | `products`, `product_categories`, `units`, `product_prices`, `stock_balances` | UI implemented |
