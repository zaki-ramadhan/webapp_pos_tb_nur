        ...
        <div ref={formRef} className="flex h-full min-h-0 flex-col overflow-hidden">
            <div className="flex flex-1 min-h-0 flex-col gap-4 lg:flex-row overflow-hidden">
                <div className="flex flex-1 min-h-0 flex-col overflow-hidden">
                    ...
                    <div className={`flex flex-1 min-h-0 flex-col rounded-[6px] ${hasTabs ? 'rounded-tl-none' : ''} border border-ui-border bg-white shadow-card-light overflow-hidden px-4 py-4 -mt-px`}>
