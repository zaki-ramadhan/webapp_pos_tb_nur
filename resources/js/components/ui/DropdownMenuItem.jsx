export default function DropdownMenuItem({
    ...
    return (
        <button
            ...
            className={`inline-flex w-full items-center gap-2.5 rounded-[3px] px-2.5 py-2 text-left text-sm leading-5 text-abc-label-dark transition-colors duration-100 ${
