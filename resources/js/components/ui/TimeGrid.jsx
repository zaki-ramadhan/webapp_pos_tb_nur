            ...
            {slots.map((slot) => {
                ...
                return (
                    <button
                        ...
                        disabled={disabled}
                        className={`inline-flex items-center justify-center rounded-[6px] py-2 px-2.5 text-xs sm:text-sm font-normal transition-colors cursor-pointer select-none focus:outline-hidden ${
                            isSelected
