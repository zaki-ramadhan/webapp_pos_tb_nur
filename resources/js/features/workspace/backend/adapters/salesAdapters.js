...
export function mapProductRow(record) {
    ...
    return {
        ...
        categoryName: record.category?.name ?? 'Umum',
        unit: record.base_unit?.name ?? record.base_unit?.code ?? record.baseUnit?.name ?? record.baseUnit?.code ?? (typeof record.unit === 'string' ? record.unit : '') ?? '',
        unitName: record.base_unit?.name ?? record.base_unit?.code ?? record.baseUnit?.name ?? record.baseUnit?.code ?? record.unitName ?? (typeof record.unit === 'string' ? record.unit : '') ?? '',
        base_unit: record.base_unit ?? record.baseUnit ?? null,
        baseUnit: record.base_unit ?? record.baseUnit ?? null,
        purchase_unit: record.purchase_unit ?? record.purchaseUnit ?? null,
        purchaseUnit: record.purchase_unit ?? record.purchaseUnit ?? null,
        purchasePrice: formatPrice(record.default_purchase_price ?? record.purchase_price ?? record.purchasePrice ?? 0),
        default_purchase_price: record.default_purchase_price ?? record.purchase_price ?? record.purchasePrice ?? 0,
        salePrice: formatPrice(record.default_sale_price ?? record.selling_price ?? record.sale_price ?? record.salePrice ?? 0),
        default_sale_price: record.default_sale_price ?? record.selling_price ?? record.sale_price ?? record.salePrice ?? 0,
        minimumStock: record.minimum_stock ?? record.minimumStock ?? 0,
        minimum_stock: record.minimum_stock ?? record.minimumStock ?? 0,
