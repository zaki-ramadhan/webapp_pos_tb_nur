...
function LimitationsSimpleRadioGroup({ row, onChange }) {
    return (
...
function LimitationsTimingRule({ block, rowId, optionValue, onToggle, onChangeBlock }) {
    return (
...
function LimitationsSearchBlock({ block, rowId, optionValue, onChangeBlock }) {
    return (
...
function LimitationsNestedRadioBlock({ block, rowId, optionValue, onChangeNestedRadio }) {
    return (
...
function LimitationsAdvancedRadioGroup({
    row,
    onChange,
    onToggleTimingRule,
    onChangeTimingRule,
