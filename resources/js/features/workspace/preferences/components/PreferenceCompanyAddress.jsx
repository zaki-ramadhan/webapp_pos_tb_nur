...
export default function PreferenceCompanyAddress({ address, values, onChange }) {
    ...
    if (!address || !cityField || !provinceField || !postalCodeField || !countryField) {
        return (
            <div className="p-4 text-[14px] text-[#65708a]">
    ...
    return (
        <div className="max-w-[980px]">
            <div className="grid gap-x-6 gap-y-2 lg:grid-cols-[160px_minmax(0,646px)] lg:items-start">
                <label className="pt-1.5 text-[14px] md:text-[15px] text-[#1f2436]">{address.label}</label>
                ...
                <div className="space-y-1.5">
                    <TextareaField
                        ...
                        rows={3}
                        prefixClassName="min-w-[72px] border-[#d8dde7] px-3 py-2 text-[14px] md:text-[15px] text-[#7b8597]"
                        className="rounded-[3px] border-[#d8dde7] shadow-[inset_0_1px_0_rgba(255,255,255,0.55)]"
                        textareaClassName="min-h-[80px] px-3 py-2 text-[14px] md:text-[15px] leading-6 text-[#1f2436]"
                    />
