...
export default function PreferencesTabs({
    ...
    return (
        <div
            className={`overflow-x-auto overflow-y-hidden bg-[#efefef] pt-1.5 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:pt-1.5 ${leftPaddingClass} ${rightPaddingClass} ${className}`.trim()}
        >
