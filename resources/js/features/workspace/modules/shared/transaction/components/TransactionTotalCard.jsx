...
export function TransactionTotalCard({ label, value, className = '' }) {
    ...
    return (
        <div
            className={`w-full sm:w-[264px] max-w-full shrink-0 overflow-hidden rounded-[4px] border border-table-cell-border bg-white shadow-card-medium ${className}`.trim()}
        >
