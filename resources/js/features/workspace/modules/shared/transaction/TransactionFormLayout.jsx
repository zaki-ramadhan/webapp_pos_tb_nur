            ...
            <div className="flex min-h-0 flex-1 flex-row gap-4">
                <div className="min-w-0 flex-1 flex flex-col h-full min-h-0 gap-1.5">
                    ...
                    <div className="flex flex-1 min-h-0">
                        ...
                        <div className="min-w-0 flex-1 overflow-y-auto px-3 pt-3 pb-3 flex flex-col bg-white border border-ui-border rounded-[6px] rounded-tl-none shadow-card-light">
                            {children}
                        </div>
                    </div>
