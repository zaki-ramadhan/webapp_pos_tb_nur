        ...
        <div>
            ...
            <div className="mt-4 rounded-[6px] border border-[#d6dce8] bg-white p-4">
                <div className="grid gap-y-4 sm:grid-cols-[260px_minmax(0,1fr)] sm:items-start sm:gap-x-4">
                    ...
                    <TextInput value={values.taxInvoiceNumber ?? ''} readOnly trailing={<span className="text-[18px] font-semibold text-[#1f2436]">×</span>} className="h-[34px] rounded-[4px] border-[#cfd6e2]" inputClassName="text-[15px] text-[#1f2436]" trailingClassName="px-3" />
                </div>
            </div>
            <div className="mt-7">
