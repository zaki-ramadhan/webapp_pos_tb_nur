...
import { WorkCompletionTableSection } from './WorkCompletionSections';

export default function WorkCompletionTableView({ config, onCreate, onOpenDetail }) {
