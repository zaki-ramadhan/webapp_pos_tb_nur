                            ...
                            filteredOptions.map((option) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`block w-full border-t border-slate-300 px-4 py-3 text-left text-sm text-brand-dark transition first:border-t-0 hover:bg-workspace-hover-bg odd:bg-white even:bg-[#F8F8F8] ${selected ? '!bg-brand-blue-lightest font-medium' : ''}`.trim()}
                                    >
