...
export default function CashPaymentLineItemModal({
    open,
    onClose,
    record = null,
    currentItem = null,
    ...
    const handleSave = () => {
        if (!selectedAccount?.id) {
            showErrorToast({ message: 'Akun pembayaran harus dipilih.' });
            setActiveTab('detail');
            return;
        }
        ...
        if (parsedAmount <= 0) {
            showErrorToast({ message: 'Nilai pembayaran harus lebih besar dari 0.' });
            setActiveTab('detail');
            return;
        }
        ...
        if (deferred) {
            if (!deferredAccount?.id) {
                showErrorToast({ message: 'Akun penangguhan harus dipilih.' });
    ...
    const tabs = [
        { id: 'detail', label: 'Rincian Pembayaran' },
            ...
            <div className="min-h-[220px] flex flex-col">
                {activeTab === 'detail' && (
                    <div className="space-y-4 flex-1 pb-4">
                        ...
                        <div className="grid grid-cols-[130px_minmax(0,1fr)] items-center gap-4">
                            <span className="text-sm text-slate-700 font-normal">Untuk Pembayaran</span>
                    ...
                    <div className="flex flex-col gap-4 flex-1 pb-4">
                        ...
                        {deferred && (
                            <div className="grid grid-cols-[130px_minmax(0,1fr)] items-center gap-y-4 border-t border-ui-border-lightest pt-4 mt-2">
                                <span className="text-sm text-slate-700 font-normal">
                                    Akun Penangguhan <span className="text-red-500">*</span>
                                </span>
                                <div className="w-full">
                                    <AccountLookupField
