...
function buildPeriodYearOptions(config, minimumYear = 2014) {
...
function PeriodEndTableView({ config, onCreate, onOpenDetail }) {
...
function PeriodEndFormView({ config, activeLevel2Tab }) {
