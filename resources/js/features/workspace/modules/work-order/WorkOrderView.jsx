...
import { buildWorkOrderConfig } from '@/features/workspace/modules/work-order/workOrderConfig';
...
export default function WorkOrderView({ page, mode, activeLevel2Tab, onOpenContent, onOpenDetail }) {
    ...
    return <WorkOrderFormView pageId={page.id} config={config} activeLevel2Tab={activeLevel2Tab} />;
}
