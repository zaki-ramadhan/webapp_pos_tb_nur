...
} from '@/features/workspace/modules/assetChangeConfig';
import {
            ...
            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(320px,520px)] xl:items-start">
                ...
                <div className="space-y-3 xl:justify-self-end xl:min-w-[420px]">
                    ...
                    <AssetChangeFieldRow label={config.labels.date} labelClassName="sm:text-right">
                        <TransactionDateInput value={values.transactionDate} className="w-full sm:max-w-[230px]" />
                    </AssetChangeFieldRow>
...
function AssetChangeFormView({ config, activeLevel2Tab }) {
...
export default function AssetChangeView({
    ...
    if (mode === 'form') {
        return <AssetChangeFormView config={config} activeLevel2Tab={activeLevel2Tab} />;
    }
