function HeaderColumn({ title, iconPath, children }) {
    return (
        <div className="flex flex-col">
            <div className="border-t-[3px] border-[#0c6b96] bg-white px-3 py-2.5 flex items-center justify-between">
                <div className="flex items-center gap-2 font-semibold text-slate-900 text-sm uppercase tracking-wider">
                    <svg className="h-4.5 w-4.5 text-[#0c6b96]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function BankReconciliationHeader({ lastKnownBalance = '0', rawBalanceNum = 0, unreconciledCount = 0 }) {
