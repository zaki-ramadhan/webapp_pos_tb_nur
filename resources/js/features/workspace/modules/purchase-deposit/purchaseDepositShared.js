...
export function buildPurchaseDepositRecord(record = {}, config = {}) {
    ...
    return {
        ...
        pphCode: record?.metadata?.pph_code ?? '',
        ...
        invoiceNumber: record?.reference_number ?? '',
...
export function buildPurchaseDepositFormState(source = {}, config = {}) {
    ...
    return {
        ...
        invoiceNumber: source.invoiceNumber ?? config.draft?.invoiceNumber ?? '',
...
export function buildPurchaseDepositPayload(values) {
    ...
    return {
        ...
        reference_number: values.invoiceNumber?.trim() || null,
        ...
        metadata: {
            ...
            pph_code: values.taxEnabled && values.__pphId ? (values.pphCode ?? null) : null,
