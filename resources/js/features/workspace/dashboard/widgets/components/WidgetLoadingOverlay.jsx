...
export default function WidgetLoadingOverlay({ isVisible = false, text = 'Menunggu..' }) {
    ...
    return (
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/60 backdrop-blur-[2px] transition-all duration-200">
            ...
            {text ? (
                <span className="mt-4 text-lg font-medium text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)] select-none">
                    {text}
                </span>
            ) : null}
        </div>
