...
import { AnalyticsWidgetLayout, DetailToggleButton } from '@/features/workspace/dashboard/analytics/AnalyticsWidgetLayout';
import {
    AbcTopItemRow,
    RuleSummaryRow,
...
export function IntegratedAnalysisWidget({ widget, expanded = false, onToggle }) {
    if (!widget.metrics || widget.metrics.length === 0) {
        return (
            <div className="flex h-full min-h-[380px] flex-col justify-between rounded-[8px] bg-slate-50 p-5 border border-slate-100 animate-pulse">
                <div className="space-y-4">
