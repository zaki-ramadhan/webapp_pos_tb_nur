...
return [
    ...
    'attributes' => [
        ...
        'subtotal' => 'Subtotal',
        'paid_amount' => 'Nominal Pembayaran',
        ...
        'account_id' => 'Akun Perkiraan',
        'debit_account_id' => 'Akun Debit',
        'credit_account_id' => 'Akun Kredit',
        'base_unit_id' => 'Satuan Dasar',
        'purchase_unit_id' => 'Satuan Pembelian',
        'sales_unit_id' => 'Satuan Penjualan',
        'unit_id' => 'Satuan',
        'product_id' => 'Barang / Produk',
        'category_id' => 'Kategori Barang',
        'barcode' => 'Barcode',
        'sku' => 'SKU',
        'stock' => 'Stok',
        'minimum_stock' => 'Stok Minimum',
        'cost_price' => 'Harga Pokok / Modal',
        'selling_price' => 'Harga Jual',
        'description' => 'Keterangan',
        'notes' => 'Catatan',
        'status' => 'Status',
        'role_ids' => 'Peran Hak Akses',
        'branch_ids' => 'Cabang',
