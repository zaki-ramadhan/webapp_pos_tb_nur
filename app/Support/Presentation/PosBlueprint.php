...
final class PosBlueprint
{
    ...
    public static function forDashboard(?string $sample = null, ?array $abc = null, ?array $apriori = null, bool $loadData = true, ?string $asOfDate = null): array
    {
        ...
        return [
            ...
            'dashboard' => [
                ...
                'sampleDashboard' => self::sampleDashboard($abc, $apriori, $loadData, $asOfDate),
    ...
    private static function sampleDashboard(?array $abc = null, ?array $apriori = null, bool $loadData = true, ?string $asOfDate = null): array
    {
        return \App\Support\Presentation\DashboardBlueprintProvider::get($abc, $apriori, $loadData, $asOfDate);
    }
