...
class PageBlueprintRegistry
{
    public static function all(array $navigationPages, array $transactionTypeOptions = []): array
    {
        return [
            ...
            'purchase-order' => Pages\PurchaseInvoicePage::get($navigationPages),
            'goods-receipt' => Pages\PurchaseInvoicePage::get($navigationPages),
            'purchase-deposit' => Pages\PurchaseInvoicePage::get($navigationPages),
            'sales-quote' => Pages\SalesInvoicePage::get($navigationPages),
            'sales-order' => Pages\SalesInvoicePage::get($navigationPages),
            'sales-delivery' => Pages\SalesInvoicePage::get($navigationPages),
