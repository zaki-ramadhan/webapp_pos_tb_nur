    ...
    public static function get(array $navigationPages): array
    {
        return array_replace($navigationPages['bank-transfer'], [
            ...
            'bankTransfer' => [
                ...
                'feeTable' => [
                    'columns' => [
                        ['id' => 'accountCode', 'label' => 'Akun', 'widthClassName' => 'w-[15%]'],
                        ['id' => 'accountName', 'label' => 'Nama Akun', 'widthClassName' => 'w-[40%]'],
                ...
                'table' => [
                    ...
                    'columns' => [
                        ...
                        ['id' => 'description', 'label' => 'Keterangan', 'widthClassName' => 'w-[28%]'],
                        ['id' => 'purchasePayment', 'label' => 'Pembayaran Pembelian', 'widthClassName' => 'w-[200px]'],
                        ['id' => 'fromTotal', 'label' => 'Total', 'widthClassName' => 'w-[140px]', 'align' => 'right'],
                        ['id' => 'toTotal', 'label' => 'Total', 'widthClassName' => 'w-[140px]', 'align' => 'right'],
                        ['id' => 'fromBranch', 'label' => 'Cabang Asal', 'widthClassName' => 'w-[150px]', 'defaultHidden' => true],
                        ['id' => 'toBranch', 'label' => 'Cabang Tujuan', 'widthClassName' => 'w-[150px]', 'defaultHidden' => true],
                        ['id' => 'feeTotal', 'label' => 'Biaya Transfer', 'widthClassName' => 'w-[140px]', 'align' => 'right', 'defaultHidden' => true],
                        ['id' => 'exchangeRate', 'label' => 'Nilai Kurs', 'widthClassName' => 'w-[130px]', 'align' => 'right', 'defaultHidden' => true],
                    ],
                    'rows' => [
                        ['id' => 'BT.2016.12.00006', 'number' => 'BT.2016.12.00006', 'date' => '16/12/2016', 'fromBank' => 'Bank BCA USD S...', 'fromBankFull' => 'Bank BCA USD Surabaya (247-878-6241)', 'toBank' => 'Bank BCA IDR Su...', 'toBankFull' => 'Bank BCA IDR Surabaya (388-308-3993)', 'description' => '', 'transferTotal' => '29,491,200', 'purchasePayment' => '', 'feeTotal' => '2,304', 'dateFilter' => '2016', 'fromBankFilter' => 'bank-bca', 'toBankFilter' => 'bank-bca', 'fromBranch' => 'TOKO UTAMA', 'toBranch' => 'TOKO UTAMA', 'exchangeRateLabel' => '1 USD=XXX IDR', 'exchangeRate' => '12,800', 'transferValue' => '2,304', 'transferPrefix' => 'USD', 'transferWords' => '# Dua ribu tiga ratus empat #', 'resultValue' => '29,491,200', 'resultPrefix' => 'IDR', 'resultWords' => '# Dua puluh sembilan juta empat ratus sembilan puluh satu ribu dua ratus #', 'fromTotalLabel' => 'Total Bank BCA USD Surabaya (24...', 'fromTotalValue' => '$ 2,304', 'toTotalLabel' => 'Total Bank BCA IDR Surabaya (388...', 'toTotalValue' => 'Rp 29,491,200', 'reconciliations' => [['id' => 'recon-a', 'bank' => 'Bank BCA USD Surabaya (247-878-6241)', 'status' => 'Belum', 'date' => ''], ['id' => 'recon-b', 'bank' => 'Bank BCA IDR Surabaya (388-308-3993)', 'status' => 'Ya', 'date' => '(11/02/2017)']]],
                        ['id' => 'BT.2016.12.00005', 'number' => 'BT.2016.12.00005', 'date' => '16/12/2016', 'fromBank' => 'Bank BCA USD J...', 'fromBankFull' => 'Bank BCA USD Jakarta', 'toBank' => 'Bank BCA IDR Ja...', 'toBankFull' => 'Bank BCA IDR', 'description' => '', 'transferTotal' => '71,120,000', 'purchasePayment' => '', 'feeTotal' => '5,600', 'dateFilter' => '2016', 'fromBankFilter' => 'bank-bca', 'toBankFilter' => 'bank-bca', 'fromBranch' => 'TOKO UTAMA', 'toBranch' => 'TOKO UTAMA'],
                        ['id' => 'BT.2016.12.00004', 'number' => 'BT.2016.12.00004', 'date' => '16/12/2016', 'fromBank' => 'Kas Besar Kantor...', 'fromBankFull' => 'Kas Besar Kantor Jakarta', 'toBank' => 'Kas Kecil Kantor ...', 'toBankFull' => 'Kas Kecil Kantor Jakarta', 'description' => '', 'transferTotal' => '8,750,000', 'purchasePayment' => '', 'feeTotal' => '8,750,000', 'dateFilter' => '2016', 'fromBankFilter' => 'cash', 'toBankFilter' => 'cash', 'fromBranch' => 'TOKO UTAMA', 'toBranch' => 'TOKO UTAMA'],
                        ['id' => 'BT.2016.12.00003', 'number' => 'BT.2016.12.00003', 'date' => '16/12/2016', 'fromBank' => 'Bank BCA IDR Su...', 'fromBankFull' => 'Bank BCA IDR Surabaya', 'toBank' => 'Kas Besar Kantor...', 'toBankFull' => 'Kas Besar Kantor Surabaya', 'description' => '', 'transferTotal' => '11,200,000', 'purchasePayment' => '', 'feeTotal' => '11,200,000', 'dateFilter' => '2016', 'fromBankFilter' => 'bank-bca', 'toBankFilter' => 'cash', 'fromBranch' => 'TOKO UTAMA', 'toBranch' => 'TOKO UTAMA'],
                        ['id' => 'BT.2016.12.00002', 'number' => 'BT.2016.12.00002', 'date' => '16/12/2016', 'fromBank' => 'Kas Besar Kantor...', 'fromBankFull' => 'Kas Besar Kantor Jakarta', 'toBank' => 'Kas Kecil Kantor ...', 'toBankFull' => 'Kas Kecil Kantor Jakarta', 'description' => 'Transfer Uang', 'transferTotal' => '12,700,000', 'purchasePayment' => '', 'feeTotal' => '12,700,000', 'dateFilter' => '2016', 'fromBankFilter' => 'cash', 'toBankFilter' => 'cash', 'fromBranch' => 'TOKO UTAMA', 'toBranch' => 'TOKO UTAMA'],
                        ['id' => 'BT.2016.12.00001', 'number' => 'BT.2016.12.00001', 'date' => '16/12/2016', 'fromBank' => 'Bank BCA IDR Ja...', 'fromBankFull' => 'Bank BCA IDR', 'toBank' => 'Kas Besar Kantor...', 'toBankFull' => 'Kas Besar Kantor Surabaya', 'description' => 'Transfer Untuk Gaji Nov 2016', 'transferTotal' => '127,500,000', 'purchasePayment' => '', 'feeTotal' => '127,500,000', 'dateFilter' => '2016', 'fromBankFilter' => 'bank-bca', 'toBankFilter' => 'cash', 'fromBranch' => 'TOKO UTAMA', 'toBranch' => 'TOKO UTAMA'],
                    ],
                ],
                'detailRecords' => [
                    'BT.2016.12.00006' => [
