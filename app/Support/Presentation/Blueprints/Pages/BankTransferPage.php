        ...
        return array_replace($navigationPages['bank-transfer'], [
            ...
            'bankTransfer' => [
                ...
                'draft' => [
                    ...
                    'notes' => '',
                    'feeRows' => [],
                    'fromTotalLabel' => 'Total Dari Kas/Bank',
                    'fromTotalValue' => '0',
                    'toTotalLabel' => 'Total Ke Kas/Bank',
                    'toTotalValue' => '0',
                    'saveTone' => 'primary',
                    'reconciliations' => [],
                ],
                ...
                'table' => [
                    ...
                    'columns' => [
                        ...
                        ['id' => 'fromBank', 'label' => 'Bank (Keluar)', 'widthClassName' => 'w-[200px]'],
                        ['id' => 'toBank', 'label' => 'Bank (Masuk)', 'widthClassName' => 'w-[200px]'],
                        ['id' => 'description', 'label' => 'Keterangan', 'widthClassName' => 'w-[32%]'],
                        ['id' => 'fromTotal', 'label' => 'Total', 'widthClassName' => 'w-[160px]', 'align' => 'right'],
                        ['id' => 'feeTotal', 'label' => 'Biaya Transfer', 'widthClassName' => 'w-[150px]', 'align' => 'right', 'defaultHidden' => true],
                    ],
                    'rows' => [
