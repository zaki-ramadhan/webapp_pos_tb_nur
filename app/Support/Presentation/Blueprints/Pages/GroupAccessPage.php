                            ...
                            'categories' => [
                                \App\Support\Presentation\PosBlueprint::accessCategory('company', 'Perusahaan', 'building', [
                                    \App\Support\Presentation\PosBlueprint::accessSection('company-menu', 'Akses Menu', [
                                        ...
                                        \App\Support\Presentation\PosBlueprint::accessRow('activity-log', 'Log Aktifitas', ['active' => true]),
                                        ...
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-ebilling', 'SmartLink Tax : e-Billing Pajak', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-efiling', 'SmartLink Tax : e-Filing Pajak', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-efaktur', 'SmartLink Tax : e-Faktur Pajak', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-spt-ppnbm', 'SmartLink Tax : e-SPT PPN/BM', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-email-faktur', 'SmartLink Tax : Email Faktur Pajak', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-spt-pph2326', 'SmartLink Tax : e-SPT PPh 23/26', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('spt-ppn', 'SPT PPn', ['create' => true, 'update' => true, 'delete' => true, 'view' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('spt-pph21', 'SPT PPh 21', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('spt-pph23', 'SPT PPh 23', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('spt-pph42', 'SPT PPh 4(2)', ['active' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('spt-pph15', 'SPT PPh 15', ['active' => true]),
                                    ]),
                                    \App\Support\Presentation\PosBlueprint::accessSection('company-other', 'Akses Lainnya', [
                                        ...
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-authority', 'SmartLink Tax : Pihak Berwenang e-Faktur Pajak', ['create' => true, 'update' => true, 'delete' => true, 'view' => true], true),
                                        \App\Support\Presentation\PosBlueprint::accessRow('smartlink-upload-all-branches', 'SmartLink Tax : Dapat unggah e-Faktur Pajak semua cabang', ['active' => true], true),
                                        \App\Support\Presentation\PosBlueprint::accessRow('report-export', 'Ekspor Laporan', ['active' => true], true),
                                        \App\Support\Presentation\PosBlueprint::accessRow('edit-efaktur-transactions', 'Mengubah/Menghapus transaksi yang sudah memiliki e-Faktur', ['active' => true], true),
                                        \App\Support\Presentation\PosBlueprint::accessRow('ai-analysis', 'Analisa AI', ['active' => true], true),
                                    ]),
                                ]),
                                ...
                                \App\Support\Presentation\PosBlueprint::accessCategory('widget', 'Widget', 'format', [
                                    \App\Support\Presentation\PosBlueprint::accessSection('widget-menu', 'Akses Menu', [
                                        \App\Support\Presentation\PosBlueprint::accessRow('widget-dashboard', 'Dashboard', ['active' => true, 'view' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('widget-library', 'Library Widget', ['active' => true, 'view' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('widget-add', 'Tambah Widget', ['create' => true]),
                                        \App\Support\Presentation\PosBlueprint::accessRow('widget-edit', 'Atur Widget', ['update' => true, 'delete' => true]),
                                    ]),
                                ]),
                            ],
                        ],
