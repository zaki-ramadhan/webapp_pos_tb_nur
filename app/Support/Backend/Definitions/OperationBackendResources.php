...
class OperationBackendResources
{
    ...
    private static function documentResource(
        ...
        return new BackendResourceBlueprint(
            ...
            with: [
                ...
                'lines.product.purchaseUnit',
                'lines.product.salesUnit',
                'lines.fixedAsset',
                'lines.account',
                'lines.unit',
                'lines.warehouse',
    ...
    private static function baseDocumentRules(bool $requireLines): array
    {
        return [
            ...
            'metadata.tax_transaction_type' => ['nullable', 'string', 'max:120'],
            'metadata.tax_invoice_number' => ['nullable', 'string', 'max:120'],
            'metadata.dpp_percent' => ['nullable', 'numeric'],
            'metadata.dpp_factor' => ['nullable', 'numeric'],
            'metadata.pph_tax_id' => ['nullable', 'integer'],
            'metadata.pph_name' => ['nullable', 'string', 'max:120'],
            'metadata.pph_rate' => ['nullable', 'numeric'],
            'metadata.pph_amount' => ['nullable', 'numeric'],
            'metadata.shipping_method_id' => ['nullable', 'integer'],
            'metadata.shipping_method_name' => ['nullable', 'string'],
            'metadata.fob_id' => ['nullable', 'integer'],
            'metadata.fob_name' => ['nullable', 'string'],
            'metadata.additional_costs' => ['sometimes', 'array'],
            'metadata.advance_payments' => ['sometimes', 'array'],
            'metadata.return_source' => ['nullable', 'string'],
            'metadata.ignore_stock_warning' => ['nullable', 'boolean'],
            'metadata.payment_type' => ['sometimes', 'string', 'max:120'],
            'metadata.period_month' => ['sometimes', 'string', 'max:120'],
            'metadata.period_year' => ['sometimes', 'string', 'max:120'],
            'metadata.branches' => ['sometimes', 'array'],
            'metadata.liability_accounts' => ['sometimes', 'array'],
            'metadata.liability_account_id' => ['sometimes', 'integer', 'nullable'],
            ...
            'metadata.orderSelections' => ['nullable', 'array'],
            'metadata.productScope' => ['nullable', 'string', 'max:120'],
            'metadata.supplierScope' => ['nullable', 'string', 'max:120'],
            'metadata.conditionType' => ['nullable', 'string', 'max:80'],
            'metadata.salesValueFrom' => ['nullable', 'numeric', 'min:0'],
            'metadata.salesValueTo' => ['nullable', 'numeric', 'min:0'],
            'metadata.quantityFrom' => ['nullable', 'numeric', 'min:0'],
            'metadata.quantityTo' => ['nullable', 'numeric', 'min:0'],
            'metadata.quantityUnit' => ['nullable', 'string', 'max:60'],
            'metadata.rewardType' => ['nullable', 'string', 'max:80'],
            'metadata.rewardValue' => ['nullable', 'numeric', 'min:0'],
            'metadata.rewardBase' => ['nullable', 'string', 'max:80'],
            'metadata.startDate' => ['nullable', 'date'],
            'metadata.endDate' => ['nullable', 'date'],
            'metadata.targetType' => ['nullable', 'string', 'max:80'],
            'metadata.branch' => ['nullable', 'string', 'max:120'],
            'metadata.analyst' => ['nullable', 'string', 'max:120'],
            'metadata.detailConfig' => ['nullable', 'array'],
            'metadata.detailConfig.rows' => ['nullable', 'array'],
            'metadata.fromBudget' => ['nullable', 'string', 'max:120'],
            'metadata.toBudget' => ['nullable', 'string', 'max:120'],
            'metadata.transferAmount' => ['nullable', 'numeric', 'min:0'],
