    ...
    public static function definitions(): array
    {
        return [
            ...
            'product-categories' => new BackendResourceBlueprint(
                ...
                with: [
                    'parent', 'inventoryAccount', 'expenseAccount', 'salesAccount', 'salesReturnAccount',
                    'salesDiscountAccount', 'goodsInTransitAccount', 'costOfGoodsSoldAccount',
                    'purchaseReturnAccount', 'unbilledPurchaseAccount'
                ],
                storeRules: [
                    ...
                    'goods_in_transit_account_id' => ['nullable', 'integer', 'exists:accounts,id'],
                    'cost_of_goods_sold_account_id' => ['nullable', 'integer', 'exists:accounts,id'],
                    'purchase_return_account_id' => ['nullable', 'integer', 'exists:accounts,id'],
                    'unbilled_purchase_account_id' => ['nullable', 'integer', 'exists:accounts,id'],
                ],
                updateRules: fn (Model $record) => [
                    'parent_id' => ['nullable', 'integer', 'exists:product_categories,id'],
