...
class BackendActivityLogger
{
    ...
    protected function resolveDescription(string $action, BackendResourceBlueprint $blueprint, Model $record): string
    {
        ...
        $resourceMap = [
            ...
            'payment-orders' => 'Perintah Pembayaran',
            ...
            'work-orders' => 'Pekerjaan Pesanan',
            'material-additions' => 'Penambahan Bahan Baku',
            'work-completions' => 'Penyelesaian Pesanan',
            'fixed-assets' => 'Aset Tetap',
            'fixed-asset' => 'Aset Tetap',
            'asset-categories' => 'Kategori Aset',
            'asset-tax-categories' => 'Kategori Pajak Aset',
            'asset-changes' => 'Perubahan Aset',
            'asset-disposals' => 'Penghentian Aset',
            'asset-moves' => 'Pindah Aset',
