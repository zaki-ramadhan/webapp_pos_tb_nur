        ...
        for ($year = $startYear; $year <= $currentYear; $year++) {
            ...
            for ($m = 3; $m <= $maxM; $m += 3) {
                ...
                $docId = DB::table('operation_documents')->insertGetId([
                    ...
                    'subtotal' => 750000,
                    'total_amount' => 750000,
                    'notes' => 'Penyesuaian stok opname fisik berkala',
                    'is_closed' => true,
                    'created_at' => $dt,
                    'updated_at' => $dt,
                ]);
            ...
            for ($m = 1; $m <= $maxM; $m++) {
                ...
                for ($crK = 1; $crK <= $crCountThisMonth; $crK++) {
                    ...
                    $docId = DB::table('operation_documents')->insertGetId([
                        ...
                        'notes' => 'Penerimaan kas pendapatan lain-lain',
                        'is_closed' => true,
                        'created_at' => $dt,
                        'updated_at' => $dt,
                    ]);
            ...
            for ($m = 1; $m <= $maxM; $m += 2) {
                ...
                for ($btK = 1; $btK <= $btCountThisMonth; $btK++) {
                    ...
                    DB::table('operation_documents')->insert([
                        ...
                        'notes' => 'Transfer dari Bank BCA ke Bank Mandiri',
                        'is_closed' => true,
                        'created_at' => $dt,
                        'updated_at' => $dt,
                    ]);
