...
class PartyEntitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('customers')->insert([
            ['category_id' => $custCatProject, 'currency_id' => $currencyId, 'code' => 'CUST-001', 'name' => 'CV. Nur Jaya Karya', 'business_phone' => '0812-5829-1020', 'mobile_phone' => '0812-5829-1020', 'email' => 'nurjaya.karya@gmail.com', 'billing_address' => 'Jl. Tomang Raya No. 100, Jakarta Barat', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $custCatRetail, 'currency_id' => $currencyId, 'code' => 'CUST-002', 'name' => 'Toko Bangunan Subur', 'business_phone' => '0812-3456-7891', 'mobile_phone' => '0812-3456-7891', 'email' => 'toko.subur.terusan@gmail.com', 'billing_address' => 'Jl. Kebon Jeruk Utama No. 45, Jakarta Barat', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $custCatRetail, 'currency_id' => $currencyId, 'code' => 'CUST-003', 'name' => 'H. Bambang Suryono', 'business_phone' => '0813-8877-6655', 'mobile_phone' => '0813-8877-6655', 'email' => 'bambang.suryono88@gmail.com', 'billing_address' => 'Jl. Meruya Indah Blok B4, Jakarta Barat', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $custCatProject, 'currency_id' => $currencyId, 'code' => 'CUST-004', 'name' => 'Ir. Ahmad Rifai (Proyek Perumahan)', 'business_phone' => '0815-9988-7766', 'mobile_phone' => '0815-9988-7766', 'email' => 'ahmad.rifai.proyek@gmail.com', 'billing_address' => 'Kawasan Proyek Perum Asri, Jakarta Barat', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $custCatRetail, 'currency_id' => $currencyId, 'code' => 'CUST-005', 'name' => 'Pak Eko Prasetyo', 'business_phone' => '0817-1122-3344', 'mobile_phone' => '0817-1122-3344', 'email' => 'eko.prasetyo.renovasi@gmail.com', 'billing_address' => 'Jl. Pos Pengumben No. 18, Jakarta Barat', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);

        // Seed suppliers (real manufacturers)
        DB::table('suppliers')->insert([
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-001', 'name' => 'PT. Semen Indonesia Tbk', 'business_phone' => '0811-9988-7711', 'mobile_phone' => '0811-9988-7711', 'email' => 'sales.semenindonesia@gmail.com', 'billing_address' => 'Gedung Utama Semen Indonesia, Jakarta', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-002', 'name' => 'PT. Rucika Plumbing Systems', 'business_phone' => '0812-9988-7722', 'mobile_phone' => '0812-9988-7722', 'email' => 'sales.rucika@gmail.com', 'billing_address' => 'Kawasan Industri Pulo Gadung, Jakarta', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-003', 'name' => 'PT. Avia Avian Tbk', 'business_phone' => '0813-9988-7733', 'mobile_phone' => '0813-9988-7733', 'email' => 'sales.avian@gmail.com', 'billing_address' => 'Kawasan Industri Jababeka, Cikarang', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-004', 'name' => 'PT. Krakatau Steel Tbk', 'business_phone' => '0815-9988-7744', 'mobile_phone' => '0815-9988-7744', 'email' => 'sales.krakatausteel@gmail.com', 'billing_address' => 'Kawasan Industri Cilegon, Banten', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-005', 'name' => 'PT. Eterna Kabel Indonesia', 'business_phone' => '0817-9988-7755', 'mobile_phone' => '0817-9988-7755', 'email' => 'sales.eternakabel@gmail.com', 'billing_address' => 'Kawasan Industri Tangerang, Banten', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);
    }
}
