...
class PartyEntitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $emp1Id = DB::table('employees')->insertGetId([
            ...
            'identity_number' => '3209011504870001',
        ...
        $emp2Id = DB::table('employees')->insertGetId([
            ...
            'identity_number' => '3209015206950002',
        ...
        $emp3Id = DB::table('employees')->insertGetId([
            ...
            'identity_number' => '3209011005880003',
        ...
        $emp4Id = DB::table('employees')->insertGetId([
            ...
            'identity_number' => '3209012209920004',
        ...
        DB::table('customers')->insert([
            ['code' => 'CUST-001', 'name' => 'CV Nur Jaya Karya', 'mobile_phone' => '081258291020', 'email' => 'nurjaya.karya@gmail.com', 'billing_address' => 'Jl. Raya Guwa Kidul No. 100, Kaliwedi, Cirebon', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'CUST-002', 'name' => 'Toko Bangunan Subur', 'mobile_phone' => '081234567891', 'email' => 'toko.subur.cirebon@gmail.com', 'billing_address' => 'Jl. By Pass Arjawinangun No. 45, Cirebon', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'CUST-003', 'name' => 'H. Bambang Suryono', 'mobile_phone' => '081388776655', 'email' => 'bambang.suryono88@gmail.com', 'billing_address' => 'Jl. Fatahillah No. 12, Plered, Cirebon', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'CUST-004', 'name' => 'Ir. Ahmad Rifai (Proyek Perumahan)', 'mobile_phone' => '081599887766', 'email' => 'ahmad.rifai.proyek@gmail.com', 'billing_address' => 'Kawasan Perumahan Asri, Kedawung, Cirebon', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['code' => 'CUST-005', 'name' => 'Pak Eko Prasetyo', 'mobile_phone' => '081711223344', 'email' => 'eko.prasetyo.renovasi@gmail.com', 'billing_address' => 'Jl. Panembahan Ratu No. 18, Weru, Cirebon', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);
