...
class PartyEntitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $emp3Id = DB::table('employees')->insertGetId([
            ...
            'position' => 'Kuli / Worker Muat Barang',
            'email' => 'andi.pratama@tbnur.com',
            'mobile_phone' => '081234567892',
            'street' => 'Jl. Raya Jatibarang No. 45',
            'city' => 'Indramayu',
            'province' => 'Jawa Barat',
            'country' => 'Indonesia',
        ...
        $emp5Id = DB::table('employees')->insertGetId([
            ...
            'position' => 'Petugas Gudang & Pengiriman',
            'email' => 'joko.widodo@tbnur.com',
            'mobile_phone' => '081234567894',
            'street' => 'Jl. Raya Sindang No. 12',
            'city' => 'Indramayu',
            'province' => 'Jawa Barat',
            'country' => 'Indonesia',
            'employment_status' => 'Permanent',
