...
class PartyEntitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('suppliers')->insert([
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-001', 'name' => 'PT. Semen Indonesia Tbk', 'business_phone' => '081199887711', 'mobile_phone' => '081199887711', 'email' => 'sales.semenindonesia@gmail.com', 'billing_address' => 'Gedung Utama Semen Indonesia, Jakarta', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-002', 'name' => 'PT. Rucika Plumbing Systems', 'business_phone' => '081299887722', 'mobile_phone' => '081299887722', 'email' => 'sales.rucika@gmail.com', 'billing_address' => 'Kawasan Industri Pulo Gadung, Jakarta', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-003', 'name' => 'PT. Avia Avian Tbk', 'business_phone' => '081399887733', 'mobile_phone' => '081399887733', 'email' => 'sales.avian@gmail.com', 'billing_address' => 'Kawasan Industri Jababeka, Cikarang', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-004', 'name' => 'PT. Krakatau Steel Tbk', 'business_phone' => '081599887744', 'mobile_phone' => '081599887744', 'email' => 'sales.krakatausteel@gmail.com', 'billing_address' => 'Kawasan Industri Cilegon, Banten', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => $suppCatMat, 'currency_id' => $currencyId, 'code' => 'SUPP-005', 'name' => 'PT. Eterna Kabel Indonesia', 'business_phone' => '081799887755', 'mobile_phone' => '081799887755', 'email' => 'sales.eternakabel@gmail.com', 'billing_address' => 'Kawasan Industri Tangerang, Banten', 'is_active' => true, 'created_at' => now(), 'updated_at' => now()],
        ]);
    }
}
